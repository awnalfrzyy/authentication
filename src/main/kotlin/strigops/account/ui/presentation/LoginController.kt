...
class AuthViewController {
    ...
    fun showRegisterPage(
        ...
        return buildString {
            appendHTML().html { 
                registerPage(errorMessage = error, successMessage = success) 
            }
        }
    }
    ...
    fun showVerifyPage(
        ...
        return buildString {
            appendHTML().html { 
                otpVerificationPage(email = email, errorMessage = error) 
            }
        }
    }
    ...
    fun showForgotPasswordPage(
        ...
        return buildString {
            appendHTML().html { 
                forgotPasswordPage(errorMessage = error, successMessage = success) 
            }
        }
    }
    ...
    fun showResetPasswordPage(
        ...
        return buildString {
            appendHTML().html { 
                resetPasswordPage(token = token, errorMessage = error) 
            }
        }
    }
