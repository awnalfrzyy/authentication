        ...
        div(classes = "relative") {
            ...
            input(type = inputType, name = name, classes = "bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full p-2.5 outline-none focus:ring-2 $borderClass") {
                ...
                when {
                    ...
                    name.contains("password", ignoreCase = true) -> attributes["autocomplete"] = "current-password"
                    name.contains("otp", ignoreCase = true) -> attributes["autocomplete"] = "one-time-code"
                }
            }
